...
public:
  ...
  inline bool operator==( const UnicodeChar& c ) const
  {
    return val_ == c.val_;
  };
  inline bool operator<=( const UnicodeChar& c ) const
  ...
  inline UnicodeChar& operator+=( const UnicodeChar& c )
  {
    val_ += c.val_;
    return *this;
  };
  ...
  inline operator char32_t() const
  {
    return val_;
  };
...
public:
  ...
  inline UnicodeString substr( size_t pos = 0, size_t len = npos )
  {
